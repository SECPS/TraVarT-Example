...
public class TraVarT {
    ...
    public static void main(final String[] args) throws NotSupportedVariabilityTypeException, IOException, PluginNotFoundException, URISyntaxException {
        TraVarTPluginManager.startPlugins();
        TraVarTPluginManager.getAvailablePlugins();
        final Path baseFolderPath = Paths.get(Paths.get(".").toRealPath().toString(), RESOURCES_PATH);
    ...
    private static void run_IVML_UVL_IVML(final Path baseFolder, final TraVarTTransformer traVarTTransformer) throws NotSupportedVariabilityTypeException, IOException, PluginNotFoundException {
