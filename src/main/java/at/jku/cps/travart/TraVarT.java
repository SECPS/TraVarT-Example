...
public class TraVarT {
	...
	private static void runTransformation(final Path baseFolder, final TraVarTTransformer traVarTTransformer,
			final String inputPluginName, final String outputPluginName)
			throws NotSupportedVariabilityTypeException, IOException, PluginNotFoundException {
		...
		traVarTTransformer.transform(inputPlugin, outputPlugin, baseFolder);
	}
}
